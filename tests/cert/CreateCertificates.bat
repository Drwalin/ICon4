...
rem provided from: https://nextbigthings.info/secured-tls-connection-using-boost-asio-and-openssl-for-windows/
rem info provided for rootca.crt and user.crt has to be different
